// vendored from https://codeberg.org/ziglang/zig/src/commit/8523ee09ae1f03d93d8029263c7bb7fe0ec282e7/lib/std/deque.zig
...
pub fn Deque(comptime T: type) type {
    return struct {
        ...
        pub fn ensureTotalCapacity(deque: *Self, gpa: Allocator, new_capacity: usize) Allocator.Error!void {
            ...
            return deque.ensureTotalCapacityPrecise(gpa, new_capacity);
        }
